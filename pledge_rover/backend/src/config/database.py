...
if is_production:
    ...
    db_name = os.environ.get("PR_DB_NAME", os.environ.get("DB_NAME", "postgres"))
    ...
    print(f"Connecting to Cloud SQL (Pledge-Rover) | Instance: {conn_name} | Socket: {socket} | DB: {db_name}")
