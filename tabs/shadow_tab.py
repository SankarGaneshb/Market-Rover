...
def show_shadow_tracker_tab():
    ...
    with tab_across:
        st.info("💡 **Pro Tip:** For institutional-grade promoter pledging analysis and contagion risk, visit the [Skin in the Game](https://pledge-rover-9514347926.us-central1.run.app) module.")
