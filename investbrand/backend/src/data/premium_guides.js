...
3. **Utility**: Does it solve a daily problem or a luxury desire?

*Mastering these allows you to vote with the precision of a Grandmaster.*`,
    icon: 'BookOpen',
    category: 'Foundations'
  },
  guide_diversification: {
...
*By voting across 3+ sectors, you are training your brain to see the whole market map.*`,
    icon: 'Shield',
    category: 'Advanced'
  },
  daily_xp_bonus: {
    ...
    description: 'A quick insight based on today\'s trending sectors.',
    content: 'Check the leaderboard! Your participation today has contributed to the collective market wisdom.',
    icon: 'Zap',
    category: 'Daily'
  }
};

module.exports = { PREMIUM_GUIDES };
