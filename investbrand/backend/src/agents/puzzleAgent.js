  ...
  try {
    ...
    const systemPrompt = `
      ...
      Your output MUST be a valid JSON object matching exactly this schema:
      {
        ...
        "clue1": "A highly obscure hint focusing on fundamental financial ratios or sector dominance (e.g. 'Known for highest ROE in its sector with zero debt').",
        "clue2": "A medium difficulty hint focusing on product lines or historical pivots.",
