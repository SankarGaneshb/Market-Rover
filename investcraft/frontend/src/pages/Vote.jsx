            ...
            <div className="flex-1 w-full max-w-7xl mx-auto flex flex-col min-h-0">
                ...
                {voteStatus === 'success' ? (
                    <div className="flex-1 flex items-center justify-center fade-in">
                        <div className="text-emerald-700 bg-emerald-50 px-16 py-12 rounded-3xl border border-emerald-200 shadow-sm flex flex-col items-center">
                            <CheckCircle className="text-emerald-500 mb-6" size={72} />
                            <h3 className="text-3xl font-bold mb-3 text-center">Vote Logged!</h3>
                            <p className="text-emerald-600 font-medium text-center text-lg">Your selected brand will be tracked for tomorrow's challenge.</p>
                        </div>
                    </div>
                ) : (
